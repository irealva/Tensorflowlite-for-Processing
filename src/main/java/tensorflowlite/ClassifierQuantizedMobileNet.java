...
public class ClassifierQuantizedMobileNet extends Classifier {
   ...
   * @param activity
   */
  public ClassifierQuantizedMobileNet(Activity activity, String modelFileInput, String labelFileInput, int sizex, int sizey) throws IOException {
    super(activity, modelFileInput, labelFileInput, sizex, sizey);
    //modelFile = modelFileInput;
    //labelFile = labelFileInput;
